...
public class SpriteObject : MonoBehaviour
{
    ...
    public void UpdateSprite()
    {
        ...
        else
        {
            ...
            sr.sprite = rotationCount == 0||sprites.Length>=rotationCount ? sprites[currentFrame] : sprites[Mathf.RoundToInt(truncatedAngle * rotationCount) * sprites.Length / rotationCount + currentFrame];
        }
    }
    void Update()
    {
